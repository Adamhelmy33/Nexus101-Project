...
export const FOUNDERS = [
  {
    ...
    gradientFrom: '#003F87',
    gradientTo: '#0066B3',
    bio: "Founded Nexus 101 (originally MathPhys101) in his first year at university and built it into a peer-education business serving students across Engineering, Pharma, and Physio — developing the instructor network, booking systems, and business infrastructure independently. He's also Chairman and Founder of the IEEE SSCS UH-GAF Student Branch Chapter.",
    quote: '"Building, learning, leveling up."',
    achievements: [
      'Founder of Nexus 101 (originally MathPhys101)',
      'IEEE SSCS UH-GAF Student Branch Chapter — Chairman & Founder',
      'Built the complete business infrastructure solo — partnership proposals, instructor agreements, onboarding systems',
    ],
    subjects: ['Physics', 'Computer Science', 'Digital Electronics'],
    linkedin: 'https://www.linkedin.com/in/mohamed-nagdy/',
    instagram: 'https://www.instagram.com/m.a.nagdy/',
  },
]
